...
#Useful Variables
font_title = { 'color': 'black', 'size': 16, 'weight': 'bold'}
font_labels = { 'color': 'black', 'size': 14}
grid_dict = {'color': 'black', 'linestyle': '--', 'linewidth': 0.5, 'alpha': 0.7, 'which': 'both'}
```
